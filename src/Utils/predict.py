...
def predict_email(text, model = 'bayes'):
    ...
    if model == 'bayes':
        ...
        model = joblib.load('models/isolation_forest/spam_classifier_model.pkl')
        vectorizer = joblib.load('models/isolation_forest/tfidf_vectorizer.pkl')    
...
def main_predict():
    ...
    elif input_method == '3' or input_method.lower() == 'csv':
